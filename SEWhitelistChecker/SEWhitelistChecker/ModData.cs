...
class ModData
{
	public static Dictionary<string,HashSet<string>> VersionData=new Dictionary<string,HashSet<string>>
	{
		["Current"]=new HashSet<string>
		{
			...
			"ProtoBuf.ProtoIncludeAttribute+*, VRage.Library",
			"ProtoBuf.ProtoIgnoreAttribute+*, VRage.Library",
			"ProtoBuf.ProtoEnumAttribute+*, VRage.Library",
			"ProtoBuf.MemberSerializationOptions+*, VRage.Library",
			"ProtoBuf.DataFormat+*, VRage.Library",
