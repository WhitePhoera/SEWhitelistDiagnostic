...
class ModData
{
	public static HashSet<string> Common=new HashSet<string>
	{
		...
		"VRageRender.MyShadowsSettings.NewStruct+*, VRage.Render",
		...
		"VRageRender.MyMaterialsSettings+*, VRage.Render",
		"VRageRender.MyMaterialsSettings.Struct+*, VRage.Render",
		"VRageRender.MyMaterialsSettings.MyChangeableMaterial+*, VRage.Render",
	};
	public static Dictionary<string,HashSet<string>> VersionData=new Dictionary<string,HashSet<string>>
	{
		...
		["1.172"]=new HashSet<string>
		{
		},
		["1.178"]=new HashSet<string>
		{
			"System.Delegate, mscorlib",
			"System.Delegate.DynamicInvoke(params object[]), mscorlib",
			"System.Delegate.Equals(object), mscorlib",
	...
	public static HashSet<string> CommonBlack=new HashSet<string>
	{
	};
